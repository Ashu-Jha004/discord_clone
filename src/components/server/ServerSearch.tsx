  ...
  return (
    <>
      <button
        ...
        className="group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transistion"
      >
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          <CommandEmpty className="">No result found</CommandEmpty>
